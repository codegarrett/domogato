  ...
  return [
    {
      ...
      children: [
        ...
        { key: 'user-stories',  label: t('nav.userStories'),  to: `/projects/${projectId}/user-stories`,  icon: 'pi pi-bookmark' },
...
function autoExpandCategoryForRoute(projectId: string) {
  ...
  const pmPaths = ['/issue-reports', '/user-stories', '/tickets', '/board', '/backlog', '/sprints', '/timeline', '/reports', '/custom-fields', '/audit-log']
