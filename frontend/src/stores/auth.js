...
export const useAuthStore = defineStore('auth', () => {
    const { isAuthenticated, accessToken, userProfile: oidcProfile, isLoading, isLocalMode, loggedOut, setAuthMode, setLocalToken, initialize, initializeOidc, login, handleCallback, logout, } = useAuth();
    ...
    async function doLocalRegister(email, password, displayName) {
        const baseUrl = import.meta.env.VITE_API_BASE_URL || '/api/v1';
    ...
    async function doLogin(returnTo) {
